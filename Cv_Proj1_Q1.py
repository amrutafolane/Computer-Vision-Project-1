...
if __name__ == '__main__':
    ...
    cv2.imshow("Input " + name_input, inputImage)
    ...
    # ----------------------------------------------------------------------------------------------------------
    # LINEAR STRETCHING of L for entire image
    # ----------------------------------------------------------------------------------------------------------
    ...
    A = 0
    B = 100
    a = 100 # Find the most minimum 'a' that you find in the window
    b = 0   # Find the most maximum 'b' that you find in the window
    ...
    # Apply Linear Stretching to entire image
    for i in range(0, rows):
        for j in range(0, cols):
            ...
            if (L < a):
                ...
                L = ( (L-a) * (B-A) / (b-a) ) + A
            tempImage[i][j].L = L # assign the new changed L back to the pixel object
    ...
    cv2.imshow("Output" + name_output,  outputImage)
